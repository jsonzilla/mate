<?php
class Mate_Posts_Widget extends WP_Widget {
	function __construct() {
		// Base ID, name
		parent::__construct ( 'mate-posts', 'Mate Posts' );
		
		add_action ( 'widgets_init', function () {
			register_widget ( 'Mate_Posts_Widget' );
		} );
	}
	public $args = array (
  ...
  <div class="section">
    <div class="row">
      <div class="col s12 m4">
        <div class="icon-block">
          <h2 class="center brown-text">
            <i class="material-icons"><?php echo esc_attr( $this->get_field_id( 'logo1' ) ); ?></i>
          </h2>
          <h5 class="center"><?php echo esc_attr( $this->get_field_id( 'title1' ) ); ?></h5>

          <p class="light"><?php echo esc_attr( $this->get_field_id( 'text1' ) ); ?></p>
        </div>
      </div>
      ...
      <div class="col s12 m4">
        <div class="icon-block">
          <h2 class="center brown-text">
            <i class="material-icons"><?php echo esc_attr( $this->get_field_id( 'logo2' ) ); ?></i>
          </h2>
          <h5 class="center"><?php echo esc_attr( $this->get_field_id( 'title2' ) ); ?></h5>

          <p class="light"><?php echo esc_attr( $this->get_field_id( 'text2' ) ); ?></p>
        </div>
      </div>
      ...
      <div class="col s12 m4">
        <div class="icon-block">
          <h2 class="center brown-text">
            <i class="material-icons"><?php echo esc_attr( $this->get_field_id( 'logo3' ) ); ?></i>
          </h2>
          <h5 class="center"><?php echo esc_attr( $this->get_field_id( 'title3' ) ); ?></h5>

          <p class="light"><?php echo esc_attr( $this->get_field_id( 'text3' ) ); ?></p>
        </div>
      </div>
    </div>
  </div>
...
$mate_text_widget = new Mate_Posts_Widget ();